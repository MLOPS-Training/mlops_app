...
from data_pipeline.training_testing.train_test_LR import train_and_test_models as train_and_test_LR
from data_pipeline.training_testing.train_test_LSVC import train_and_test_models as train_and_test_LSVC
    ...
    try:
        ...
        while True:
            ...
            for file_path in new_files:
                if file_path.is_file():
                    ...
                    file_hash = hashlib.md5(
                        file_path.stem.encode('utf-8')).hexdigest()
            ...
            if current_time - event_handler.last_message_time >= 30:
                ...
                print(
                    "Training and testing Logistic Regression model will begin soon...")
